...
import { LayoutDashboard, Settings, ChevronLeft, ChevronRight, Globe, MousePointerClick, LayoutGrid, Users, Building2, Palette, BarChart3, FileText, Tags, Database, Package } from 'lucide-react';
