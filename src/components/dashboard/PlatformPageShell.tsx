...
export function PlatformPageShell({
  ...
  // Conversions KPI MUST come from sum(conversions_lower_funnel) in bq_lovable_overview.
  // Do not derive it from the conversion-breakdown RPC or any other source.
