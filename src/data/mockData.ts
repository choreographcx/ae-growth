...
export const defaultClient: ClientProfile = {
  ...
  platforms: {
    meta: { key: 'meta', label: 'Meta', enabled: true, color: 'hsl(214, 89%, 52%)', accountIds: ['act_123456'], budget: 55000, budgetType: 'monthly', primaryKpi: 'conversions', conversionSource: 'pixel', includeInOverview: true, includeInDiagnostics: true, reportingCurrency: 'USD', sourceLabel: '', namingConvention: '', excludedCampaignFilter: '', notes: '' },
    google: { key: 'google', label: 'Google Ads', enabled: true, color: 'hsl(142, 71%, 45%)', accountIds: ['123-456-7890'], budget: 45000, budgetType: 'monthly', primaryKpi: 'conversions', conversionSource: 'tag', includeInOverview: true, includeInDiagnostics: true, reportingCurrency: 'USD', sourceLabel: '', namingConvention: '', excludedCampaignFilter: '', notes: '' },
    tiktok: { key: 'tiktok', label: 'TikTok', enabled: true, color: 'hsl(340, 82%, 52%)', accountIds: ['tt_789012'], budget: 20000, budgetType: 'monthly', primaryKpi: 'conversions', conversionSource: 'pixel', includeInOverview: true, includeInDiagnostics: true, reportingCurrency: 'USD', sourceLabel: '', namingConvention: '', excludedCampaignFilter: '', notes: '' },
    snapchat: { key: 'snapchat', label: 'Snapchat', enabled: true, color: 'hsl(50, 100%, 50%)', accountIds: ['sc_345678'], budget: 10000, budgetType: 'monthly', primaryKpi: 'impressions', conversionSource: 'pixel', includeInOverview: true, includeInDiagnostics: true, reportingCurrency: 'USD', sourceLabel: '', namingConvention: '', excludedCampaignFilter: '', notes: '' },
    x: { key: 'x', label: 'X', enabled: false, color: 'hsl(0, 0%, 20%)', accountIds: [], budget: 0, budgetType: 'monthly', primaryKpi: 'clicks', conversionSource: 'pixel', includeInOverview: true, includeInDiagnostics: false, reportingCurrency: 'USD', sourceLabel: '', namingConvention: '', excludedCampaignFilter: '', notes: '' },
