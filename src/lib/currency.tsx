...
function SarSymbol({ className = '', style }: { className?: string; style?: React.CSSProperties }) {
  return (
    <svg
      ...
      aria-label="SAR"
      className={className}
      style={{ height: '0.9em', width: 'auto', display: 'inline-block', verticalAlign: '-0.15em', ...style }}
    >
...
function AedSymbol({ className = '', style }: { className?: string; style?: React.CSSProperties }) {
  return (
    <svg
      ...
      aria-label="AED"
      className={className}
      style={{ height: '0.7em', width: 'auto', display: 'inline-block', verticalAlign: 'baseline', ...style }}
    >
...
export function CurrencySymbol({ currency, size, className = '' }: { currency: string; size?: number; className?: string }) {
  ...
  if (currency === 'SAR') return <SarSymbol className={className} style={sizeStyle} />;
  if (currency === 'AED') return <AedSymbol className={className} style={sizeStyle} />;
