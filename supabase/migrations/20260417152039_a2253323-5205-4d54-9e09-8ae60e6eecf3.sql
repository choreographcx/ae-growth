...
CREATE FUNCTION public.get_dashboard_daily(
  p_start date,
  p_end date,
...
begin
  ...
  group by d.date, d.platform, d.campaign_id, d.campaign_name, d.campaign_type, d.campaign_objective, d.audience_type
